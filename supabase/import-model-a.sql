...
values
  ...
  ('model_a', 'structure', '20', 'Written Expression', null, null, null, 'During his twelve year there, Ellis Marsalis turned the New Orleans Center for the Creative Arts into a rich training place for future jazz stars.', 'twelve', 'turned', 'a rich', 'jazz stars', 'A'),
  ...
  ('model_a', 'structure', '24', 'Written Expression', null, null, null, 'A conductor uses signals and gestures to let the musicians to know when to play various parts of a composition.', 'uses', 'musicians', 'to know', 'to play', 'C'),
  ('model_a', 'structure', '25', 'Written Expression', null, null, null, 'If a glass lizard loses its tails, a new one grows to replace it.', 'If', 'tails', 'new', 'to replace', 'B'),
  ('model_a', 'structure', '26', 'Written Expression', null, null, null, 'Many of the recording instruments used in vary branches of science are kymographs.', 'recording', 'in vary', 'branches', 'are', 'B'),
  ('model_a', 'structure', '27', 'Written Expression', null, null, null, 'It was near end of prehistoric times that the first wheeled vehicles appeared.', 'near end', 'prehistoric', 'that the first', 'wheeled', 'A'),
  ...
  ('model_a', 'structure', '29', 'Written Expression', null, null, null, 'Designers of athletic footwear finely tune each category of shoe to its particularly activity by studying human motion and physiology.', 'athletic footwear', 'category of shoe', 'particularly', 'studying', 'C'),
  ...
  ('model_a', 'structure', '32', 'Written Expression', null, null, null, 'In the United States among 60 percent of the space on the pages of newspapers is reserved for advertising.', 'among', 'the space', 'is reserved', 'advertising', 'A'),
  ...
  ('model_a', 'structure', '37', 'Written Expression', null, null, null, 'The American anarchist Emma Goldman infused her spirited lectures, publishes, and demonstrations with a passionate belief in the freedom of the individual.', 'publishes', 'with a', 'belief', 'individual', 'A'),
